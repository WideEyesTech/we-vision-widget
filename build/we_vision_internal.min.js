...
/***/ function(module, exports, __webpack_require__) {
	...
	window.onmessage = function(e) {
	  if (e.data.name === 'we-reload' && e.data) {
	    return loader.render(e.data);
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "/*\n  ******************\n  IFRAME CSS STYLING\n  ******************\n*/\n\nbody {\n  overflow: hidden;\n}\n\n.grid {\n  overflow: visible;\n}\n\n.grid > h2 {\n  padding-left: 5px;\n}\n\n.card {\n  overflow: hidden;\n  position: relative;\n  margin-bottom: 15px;\n}\n\n.card article.more-info {\n  transition: top .2s ease-out;\n  background-color: rgba(255, 255, 255, 0.5);\n  position: absolute;\n  height: 100%;\n  width: 100%;\n  top: 100%;\n  left: 0;\n}\n\n.card.hover article.more-info {\n  transition: .2s top ease-out;\n  top: 0;\n}\n\n.card article.more-info header {\n  margin-top: 30%;\n}\n\n.card article.more-info header h1 {\n  padding: 15px;\n}\n\n.card .inner .image-container {\n  position: relative;\n}\n\n.card .inner .image-container > a > img {\n  display: block;\n  margin: 0 auto;\n  max-width: 100%;\n}\n\n#preview {\n  position: absolute;\n  top: 0;\n  left: -100%;\n}", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "/* HELPER CLASSES */\n.cleafix {\n  overflow: auto;\n  zoom: 1;\n}\n\n.hover-all {\n\tposition: absolute;\n\tdisplay: block;\n\theight: 100%;\n\ttop: 0;\n\tleft: 0;\n}\n\n.separator {\n\tborder-bottom: 1px solid;\n\tmargin: 0 0 30px; \n}", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".text-color {color: #444;}\n.background-color {color: white;}", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $, Backbone, Event, Handlebars, Loader, Magnifier, WidgetContainer,
	...
	Handlebars = __webpack_require__(20);

	Event = __webpack_require__(27);

	WidgetContainer = __webpack_require__(28);

	Magnifier = __webpack_require__(35);
	...
	Loader = (function(superClass) {
	  ...
	  Loader.prototype.render = function(payload) {
	    var widget_container;
	    if (payload) {
	      this.config = payload.data.config || config;
	      this.products = payload.data.products || products;
	      this.product_id = payload.data.product_id || product_id;
	    } else {
	    ...
	    this._applyStyling(this.config);
	    if (this.config.image && this.config.image.magnifier) {
	  ...
	  Loader.prototype._removePrevious = function() {
	    var child, parent, previews;
	    ...
	    if (previews) {
	      return previews.innerHTML = '';
	    }
	  };

	  Loader.prototype._updateMagnifier = function() {
	    var evt, prev;
	    prev = $('#preview');
	    evt = null;
	    this.m = null;
	    evt = new Event;
	    this.m = new Magnifier(evt);
	    this.m.attach({
	      thumb: ".productsImage",
	      largeWrapper: 'preview',
	      zoomable: true,
	      onthumbmove: function() {
	        var body, doc, event, eventDoc;
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function(factory) {
	  ...
	  if (true) {
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(19), __webpack_require__(16), exports], __WEBPACK_AMD_DEFINE_RESULT__ = function(_, $, exports) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Utils = __webpack_require__(23);
	var Exception = __webpack_require__(25)["default"];
	var COMPILER_REVISION = __webpack_require__(22).COMPILER_REVISION;
	var REVISION_CHANGES = __webpack_require__(22).REVISION_CHANGES;
	var createFrame = __webpack_require__(22).createFrame;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $, Backbone, ProductsContainer, WidgetContainer, jsonTemplate,
	  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
	  hasProp = {}.hasOwnProperty;
	...
	jsonTemplate = __webpack_require__(29);

	ProductsContainer = __webpack_require__(30);

	WidgetContainer = (function(superClass) {
	  ...
	  WidgetContainer.prototype.render = function() {
	    ...
	    this._finishImpression();
	    WidgetContainer.__super__.render.apply(this, arguments);
	    return this;
	  };

	  WidgetContainer.prototype._finishImpression = function() {
	    var headers;
	    headers = {};
	    headers.apikey = this.widget_configuration.apikey;
	    return $.ajax({
	      method: "POST",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Backbone, ProductContainer, ProductsContainer,
	  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
	  hasProp = {}.hasOwnProperty;

	Backbone = __webpack_require__(18);

	ProductContainer = __webpack_require__(31);

	ProductsContainer = (function(superClass) {
	  ...
	  ProductsContainer.prototype.template = __webpack_require__(33);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $, Backbone, ProductContainer, _onMouseEnter, _onMouseLeave,
	  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
	  hasProp = {}.hasOwnProperty;
	...
	ProductContainer = (function(superClass) {
	  var self;
	  ...
	  ProductContainer.prototype.template = __webpack_require__(32);
	  ...
	  ProductContainer.prototype._finishImpression = function() {
	    var headers;
	    headers = {};
	    ...
	    return $.ajax({
	      ...
	      data: JSON.stringify({
	        page_product_id: this.product_id,
	        target_product_id: this.model.ProductId
	      }),
	      dataType: 'json',
	      contentType: 'application/json; charset=UTF-8',
	      headers: headers,
	  ...
	  ProductContainer.prototype._onClick = function() {
	    ...
	    headers = {};
	    headers.apikey = this.config.apikey;
	    this._genericClickCall(headers);
	    this._targetClickCall(this.model.ProductId, this.product_id, headers);
	    return this;
	  };

	  ProductContainer.prototype._genericClickCall = function(headers) {
	    return $.ajax({
	      method: "POST",
	  ...
	  ProductContainer.prototype._targetClickCall = function(targetId, ProductId, headers) {
	    return $.ajax({
	      method: "POST",
