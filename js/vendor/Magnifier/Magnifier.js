  ...
  var Magnifier = function (evt, options) {
    var gOptions = options || {},
      ...
      onThumbEnter = function () {
        ...
        document.getElementById(curData.largeWrapperId).style.visibility = 'visible';
      ...
      onThumbLeave = function () {
        document.getElementById(curData.largeWrapperId).style.visibility = 'hidden';
    ...
    this.set = function (options) {
      ...
      data[idx] = {
        ...
        status: 0,
        largeUrl: largeUrl,
        largeWrapperId: mode !== 'inside' ? largeWrapper.id : null,
        largeWrapperW: mode !== 'inside' ? largeWrapper.offsetWidth : null,
        largeWrapperH: mode !== 'inside' ? largeWrapper.offsetHeight : null,
        onzoom: onzoom,
    ...
    evt.attach('mouseout', document, function (e) {
      pos.x = e.clientX;
      pos.y = e.clientY;
